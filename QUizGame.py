...
def main(page: ft.Page) -> None:
    ...
    cash_talk: TextField = TextField(value='LOADING...', text_align=ft.TextAlign.CENTER, width = 100 )
    qtextfield: TextField = TextField(value= "", text_align=ft.TextAlign.CENTER, width =500)


    def first_button() -> None:
        pass
    def second_button() -> None:
        pass
    def third_button() -> None:
        pass
    def four_button() -> None:
        pass
    ...
    def phase_one():
        ...
        while time.time() < end_time:
            ...
            seconds_in_flet = (f"{time_left} seconds remaining! \n 'Since question started'")
            time.sleep(1)
